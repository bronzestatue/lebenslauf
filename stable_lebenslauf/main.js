...
// Toggle for data-driven mode. If true, load from JSON files; otherwise use embedded data.
const USE_DATA_FILES = true;

// Work Experience fallback data (used when not loading from JSON files)
const experiencesFallback = [
    ...
    },
    {
        ...
        location: "Remote",
        companyLink: "https://www.burda.com/",
    ...
    },
    {
        ...
        employmentType: "Teilzeit",
        location: "Berlin",
        companyLink: "https://www.tier.app/",
...
// Certifications data (embedded copy of certifications.json)
const certifications = [
  {
    "title": "Elements of AI for Business",
    "issuer": "MinnaLearn",
    "year": "2026",
    "url": "https://courses.minnalearn.com/certificate/en/elements-of-ai-for-business/221bff01-5c58-4c08-8d53-49a25e5e9b84",
    "details": "Weiterbildung im Bereich KI; Anwendung webbasierter Automatisierungslösungen und Visualisierung strukturierter Daten."
  },
  {
    "title": "KI Spezialist",
    "issuer": "Match4IT",
  ...
  {
    "title": "KI - Chancen und Risiken für die Cybersicherheit",
    "issuer": "Hubert Burda Media",
    "year": "2023",
    "url": ""
  },
  {
  ...
  {
    "title": "Grundlegendes zur Parallelität in MySQL",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  {
    "title": "Grundlegendes zur Client-Server-Kommunikation in MySQL",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  {
    "title": "Konfigurieren von Speicher- und Dateidiensten",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  ...
  {
    "title": "Programmieren mit Transact-SQL",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  {
    "title": "Erste Schritte mit Abfragen mit Transact-SQL",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  ...
  {
    "title": "How to Transform Tables with SQL Course",
    "issuer": "Codecademy",
    "year": "2019",
    "url": ""
  },
  ...
  {
    "title": "Aufbereiten von Daten für die Analyse mit Power BI",
    "issuer": "Microsoft Learn",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Abrufen und Transformieren von Daten mit Power BI",
    "issuer": "Microsoft Learn",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Power BI – Vom Datenchaos zur effektiven Entscheidungsgrundlage",
    "issuer": "Hubert Burda Media",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Power BI für Einsteiger:innen",
    "issuer": "Hubert Burda Media",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Erste Schritte mit Power BI",
    "issuer": "Microsoft Learn",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Einführung in SAP S/4 HANA",
    "issuer": "Hochschule Fresenius",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Data Science - Definition, Grundlagen und Anwendungsbeispiele",
    "issuer": "Hochschule Fresenius",
    "year": "2022",
    "url": ""
  },
  {
    "title": "Microsoft Excel VBA: Grundlagen der Programmierung",
    "issuer": "Hochschule Fresenius",
    "year": "2022",
    "url": ""
  },
  ...
  {
    "title": "Verwalten von Einstellungen für einen lokalen Windows-Computer mithilfe von PowerShell-Cmdlets",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  {
    "title": "Erstellen und Verwalten geplanter Aufträge mithilfe von Windows PowerShell",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  {
    "title": "Erstellen und Verwalten von Hintergrundaufträgen mithilfe von Windows PowerShell",
    "issuer": "Microsoft Learn",
    "year": "2024",
    "url": ""
  },
  {
    "title": "Work with different technologies in Power Automate for desktop",
    "issuer": "Microsoft Learn",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Implement advanced logic in Power Automate for desktop",
    "issuer": "Microsoft Learn",
    "year": "2023",
    "url": ""
  },
  ...
  {
    "title": "Automate processes with Robotic Process Automation and Power Automate for desktop",
    "issuer": "Microsoft Learn",
    "year": "2023",
    "url": ""
  },
  {
    "title": "Automate a business process with Power Automate",
    "issuer": "Microsoft Learn",
    "year": "2023",
    "url": ""
  },
  ...
  },
  {
    ...
    "issuer": "PADI",
    "year": "2024",
    "url": "https://achievements.padi.com/faa80b73-a620-48a7-a8ed-d29169464eab"
  }
];

// Embedded experiences data (copy of experiences.json)
const experiences = [
  {
    "title": "IT Consultant",
    "company": "HAVI Solutions GmbH & Co. KG",
    ...
    "companyLink": "https://www.havi.com/",
    "description": [
      "Optimierung von Datenmigrations-Workflows (SQL → XML)",
      "Datenanalyse mit SQL und Perl zur Identifikation von Mustern",
      "Automatisierung wiederkehrender Aufgaben mit Bash & PowerShell",
      "Abstimmung technischer Anforderungen mit Fachbereichen; Effizienzsteigerung"
    ]
  },
  {
    "title": "Business Intelligence & Data Analytics",
    ...
    "companyLink": "https://www.burda.com/",
    "description": [
      "Konzeption und Pflege von Zeiterfassungssystemen in Excel",
      "Finanzanalysen und Reporting mit KNIME; Erstellung von Visualisierungen",
      "Evaluierung und Empfehlung passender Analysetools und Softwarelösungen",
      "Erstellung aussagekräftiger Berichte für Entscheidungsträger"
    ]
  },
  {
    "title": "Datenerfasser",
    ...
    "companyLink": "https://www.tier.app/",
    "description": [
      "Digitalisierung und Archivierung eingehender Dokumente in Google Drive",
      "Datenaufbereitung und Validierung in Google Sheets zur Qualitätssteigerung",
      "Durchgeführte Analysen zur Prozessverbesserung und Kostensenkung",
      "Verfasser von zwei wissenschaftlichen Arbeiten in Kooperation mit TIER Mobility"
    ]
  },
  {
    "title": "Datenanalyst",
    ...
    "companyLink": "https://www.sasserath-munzinger.de/",
    "description": [
      "Auslese, Bereinigung und Analyse von Umfragedaten (SPSS → Excel)",
      "Erstellung von Pivot-Tabellen und Diagrammen zur Visualisierung",
      "Erstellung einer professionellen Präsentation mit erklärenden Ergebnissen",
      "Statistische Auswertung und Berichtserstellung"
    ]
  },
  {
    "title": "Junior Software Developer & IT-Support",
    ...
    "companyLink": "https://www.havi.com/",
    "description": [
      "Automatisierung und Migration von Datenbanken mit Bash, Perl und Java",
      "Mitwirkung an Java-Entwicklung im agilen Umfeld (Scrum, Git)",
      "Entwicklung von Dokumenten-Automatisierungen mittels Excel-gestützter Vorlagen",
      "Recherche und Dokumentation zu Cloud- und Container-Technologien (AWS, Docker, Kubernetes)"
    ]
  },
  {
    "title": "EDV-Programmierer",
    ...
    "companyLink": "https://www.motion-fashion.com/",
    "description": [
      "Export von proMO-Daten in SAP XML und Systemintegration",
      "Implementierung der Google Maps API für interaktive Standortdarstellungen",
      "Produktinformationsmanagement (PIM): Konsolidierung und Standardisierung von Produktdaten",
      "Automatisierung von Workflows und Validierungsregeln zur Reduktion von Fehlern"
    ]
  },
  {
    "title": "Team Lead",
    ...
    "companyLink": " ",
    "description": [
      "Leitung eines 12-köpfigen Verkaufsteams; 70% überdurchschnittliche Installationsrate",
      "Koordination von Installation, Beratung und Partnerzusammenarbeit",
      "Projektfinanzierung und Zusammenarbeit mit staatlichen Stellen und Energieversorgern"
    ]
  }
];
...
function createExperienceElement(experience) {
    ...
    header.innerHTML = `
      <div>
        ...
        <p class="company"><a href="${experience.companyLink || '#'}" target="_blank">${experience.company}</a></p>
        <p class="details"><span class="employment-type">${experience.employmentType}</span> | <span class="location">${experience.location}</span></p>
      </div>
    ...
    // Render description: array -> ul, string -> paragraph
...
function createCertificationElement(cert) {
  ...
  const hasUrl = !!(cert && cert.url);
  const titleHtml = hasUrl ? `<a href="${cert.url}" class="publication-title" target="_blank" rel="noopener">` : '<div class="publication-title">';
  const titleClose = hasUrl ? '</a>' : '</div>';
    ...
    <div class="group relative flex justify-between items-start">
      <div>
        ${titleHtml}
          <h3>${cert.title}</h3>
        ${titleClose}
        <p class="date">${cert.issuer || ''}${cert.year ? ', ' + cert.year : ''}</p>
        ${cert.details ? `<p class="description">${cert.details}</p>` : ''}
      </div>
      ${hasUrl ? `<a href="${cert.url}" class="external-link" aria-label="External link to certification" target="_blank" rel="noopener"><i data-lucide="external-link"></i></a>` : ''}
    </div>
  `;
...
// Load experiences (from file when enabled, otherwise use fallback)
  ...
  if (USE_DATA_FILES) {
    try {
      ...
      if (res.ok) {
        ...
        const currentCount = container.querySelectorAll('.experience-item').length;
        if (Array.isArray(remote) && remote.length > currentCount) {
          container.innerHTML = '';
          remote.forEach(exp => container.appendChild(createExperienceElement(exp)));
        }
      } else {
        console.warn('experiences.json returned', res.status);
      }
    } catch (err) {
...
// Load certifications (from file when enabled, otherwise use embedded array)
async function loadCertifications() {
  const container = document.querySelector('.certification-items');

  const SKILL_CATEGORIES = {
    ai: ['ki', 'künstlich', 'artificial', 'elements of ai', 'künstliche'],
    bi: ['sql', 'power bi', 'knime', 'business intelligence', 'analyze data', 'bi'],
    cloud: ['aws', 'azure', 'gcp', 'cloud', 'sap', 's/4', 's4 hana'],
    automation: ['power automate', 'automate', 'robotic', 'rpa', 'bash', 'powershell'],
    programming: ['python', 'java', 'c#', 'c++', 'codecademy', 'learn', 'transact-sql', 'r', 'ruby'],
    web: ['react', 'node', 'javascript', 'html', 'css', 'google maps', 'pim']
  };

  const CATEGORY_LABELS = {
    ai: 'Künstliche Intelligenz',
    bi: 'Datenanalyse & Business Intelligence',
    cloud: 'Cloud & Infrastruktur',
    automation: 'Prozessautomatisierung',
    programming: 'Programmiersprachen',
    web: 'Web',
    other: 'Weitere Zertifizierungen'
  };

  function categorize(cert) {
    const text = ((cert.title || '') + ' ' + (cert.issuer || '')).toLowerCase();
    for (const key of Object.keys(SKILL_CATEGORIES)) {
      for (const kw of SKILL_CATEGORIES[key]) {
  ...
  function renderGrouped(list) {
    container.innerHTML = '';
    const groups = { ai: [], bi: [], cloud: [], automation: [], programming: [], web: [], other: [] };
    list.forEach(cert => {
      const cat = categorize(cert) || 'other';
      groups[cat].push(cert);
    });

    for (const key of ['ai','bi','cloud','automation','programming','web','other']) {
      const items = groups[key];
      if (!items || !items.length) continue;
      const section = document.createElement('div');
      section.className = 'cert-section';
      section.id = `certs-${key}`;
      const h = document.createElement('h3');
      h.textContent = CATEGORY_LABELS[key] || key;
      section.appendChild(h);
      items.forEach(cert => section.appendChild(createCertificationElement(cert)));
  ...
  if (USE_DATA_FILES) {
    try {
      ...
      if (res.ok) {
        const remote = await res.json();
        const currentCount = container.querySelectorAll('.certification-item').length;
        if (Array.isArray(remote) && remote.length > currentCount) {
          renderGrouped(remote);
        }
      } else {
        console.warn('certifications.json returned', res.status);
      }
    } catch (err) {
      console.warn('Failed to fetch certifications.json; keeping embedded or inline data.', err);
    }
  } else {
    const hasItems = container.querySelectorAll('.certification-item').length > 0;
    if (!hasItems && Array.isArray(certifications)) {
      renderGrouped(certifications);
    }
  }
...
// Safe reader for embedded JSON script tags
...
// Try fetch -> embedded script -> inline fallback
async function loadDataWithFallback(url, embeddedId, inlineFallback) {
  if (USE_DATA_FILES) {
    try {
      ...
      console.warn(`${url} returned ${res.status}, will try embedded JSON fallback.`);
    } catch (err) {
      console.warn(`Fetch for ${url} failed, will try embedded JSON fallback.`, err);
    }
  }

  // Try embedded JSON in the page
  const embedded = readEmbeddedJSON(embeddedId);
  if (embedded) return embedded;

  // Last resort: use inline fallback
